          ...
          return (
            <img
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = '<div style="width:60px;height:60px;border:1px solid #f44336;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:10px;color:#f44336;">Error</div>';
              }}
            />
          );
        }
          ...
          return (
            <>
              <Box display="flex" gap={1}>
                <Button variant="contained" color="info" size="small" onClick={() => window.open(`/admin/posts?categoryId=${category.id}`, '_self')}>
                  View Posts
                </Button>
                <Button variant="contained" color="primary" size="small" onClick={() => handleEdit(category)}>
                  Edit
                </Button>
                <Button
                  variant="contained"
